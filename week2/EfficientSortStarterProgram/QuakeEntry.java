...
public class QuakeEntry implements Comparable<QuakeEntry>{
    ...
    public int compareTo(QuakeEntry loc) {
        /* compareTo method should now sort quake by magnitude first, from smallest
         * magnitude to largest magnitude, and then break ties (use == operator to
         * determine whether magnitudes are equal) by depth, from smallest (most negative)
